...
import * as redeemingService from '../components/redeeming/service/RedeemingService'
...
export const Redeeming = () => {
    ...
    const fetchContract = async () => {
        try {
            const response = await redeemingService.getContractList(page)
            // setContract(getContract)
            console.log('API response:', response);
            setContract(response.content)
                                                ...
                                                <div className="d-flex col-12 justify-content-end">
                                                    <nav aria-label="...">
                                                        <ul className="pagination">
                                                            ...
                                                            {/*    </a>*/}
                                                            {/*</li>*/}
                                                            <li hidden={page + 1 === totalPages} className="page-item">
